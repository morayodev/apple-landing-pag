      ...
      <>
        <div className=" block md:flex md:mx-10 mx:0 pt-4">
          ...
          >
            ...
            <div className="flex mt-3 sm:text-xl text-base justify-center mb-10 ">
              <p className="pr-10 md:pr-2 lg:pr-10">Learn more</p>
              <p>Try it free</p>
            </div>
        ...
        <div className=" block md:flex md:mx-10 mx:0 pt-4">
          <div
            ...
            style={{ backgroundColor: "#FBFBFD" }}
          >
            <h1 className="text-black text-xl md:text-4xl font-medium flex justify-center items-center ">
              <Appleicons />
              Card
            </h1>
            <div>
              <p className="text-base sm:text-xl w-7/12 md:w-full lg:w-6/12 m-auto text-center">
          ...
          <div
            ...
            style={{ backgroundColor: "#FBFBFD" }}
          >
            <h1 className="text-base sm:text-xl w-7/12 md:w-full m-auto font-medium ">
              Gifts for Valentine's Day
            </h1>
            <p className=" text-3xl lg:text-4xl font-medium md:w-10/12 lg:w-5/12 w-5/12 mx-auto">
              For lovers of Apple.
            </p>
